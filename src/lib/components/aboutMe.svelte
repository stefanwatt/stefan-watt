<div id="about" class="font-mono bg-primary-content py-8">
  ...
  <div class="text-3xs md:text-sm md:xs flex justify-center mt-4 p-4">
    <div class="flex items-center mr-4">
      <svg  class="w-3 h-3 md:w-8 md:h-8" viewBox="0 0 24 24">
        <path
          fill="currentColor"
          d="M12,11.5A2.5,2.5 0 0,1 9.5,9A2.5,2.5 0 0,1 12,6.5A2.5,2.5 0 0,1 14.5,9A2.5,2.5 0 0,1 12,11.5M12,2A7,7 0 0,0 5,9C5,14.25 12,22 12,22C12,22 19,14.25 19,9A7,7 0 0,0 12,2Z" />
      </svg>
      <span class="px-2">Cologne, Germany</span>
    </div>
    <div class="flex items-center mr-4">
      <svg  class="w-3 h-3 md:w-8 md:h-8" viewBox="0 0 24 24">
        <path
  ...
  <div class="p-8">
    <p>
      I'm a young developer that is passionate about the <a
        ...
        <i>Svelte</i></a> Ecosystem and modern web dev technology in general.
    </p>
    <p class="mt-2">
      I really like to customize my tooling such as my OS, IDE and keyboard to
      my personal preference. That's why I only use <i>Linux (Arch)</i> and a
      custom keyboard these days. I'm also starting to get into <i>VSCode</i>
      Extension development and simultaneously checking out <i> NeoVim </i> and
      <i>Emacs Doom</i>.
    </p>
    <p class="mt-2">
      Hopefully this website will give you a better impression of me as a
